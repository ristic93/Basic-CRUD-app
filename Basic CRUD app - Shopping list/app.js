...
const printing = () => {
    ...
    list.forEach((element,idx) => {
        ...
        <td><button class="btn-update btn btn-warning  btn-sm" onClick="edit(${idx})">Edit <i class="bi bi-pencil"></i></button></td>
        <td><button class="btn-erase btn btn-danger btn-sm " onClick="erasing(${idx})">Delete <i class="bi bi-trash3"></i></button></td>
        `
    });
}
